...
// lazy 関数により遅延コンポーネントを生成
// 遅延コンポーネントは別ファイルに分割され、初めてレンダリングされるときに非同期読み込みされます
...
function Copyright() {
    return (
        <Typography variant="body2" color="textSecondary" align="center">
            {'Copyright © '}
            <Link color="inherit" href="https://www.3140pa.com/">
    ...
    return (
        <div className={classes.root}>
            ...
            <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
                <Toolbar className={classes.toolbar} style={{ background: '#81c784' }}>
                    <IconButton
                        edge="start"
                        color="inherit"
